                            ...
                            <div class="form-group" style="margin-top:10px">
                                ...
                                <div class="col-xs-3">
                                  ...
                                  <select id="approval" name="status" class="form-control">
                                      ...
                                      <option value="Approved" > Return </option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-xs-12" style="margin-top:15px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-4">
                                         <textarea class="textarea" name="isi_nota" placeholder="isi nota" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                                         </textarea>
                                </div>
